...
<input type="hidden" name="command" value="addDriver" />
  ...
  <div class="form-group">
    ...
    <input class="form-control" type="tel" id="phone" name="phone" placeholder="+(XX0)XX-XXX-XXXX" pattern="\+\([0-9]{3}\)[0-9]{2}-[0-9]{3}-[0-9]{4}">
  </div>
  
   <div class="form-group">
    <label for="exampleFormControlInput1"><fmt:message key="driver.passport" /></label>
    <input class="form-control"  id="passport" name="passport" placeholder="XXXXXXXXX" pattern="[0-9]{9}">
  </div>
